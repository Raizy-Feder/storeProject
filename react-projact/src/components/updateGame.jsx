...
import { updateGame } from "../axios/GameAxios"
...
export const UpdateGame = () => {
    ...
    const f1 = async () => {
        let y = await updateGame(code, obj)
        if (y.data) {
            //רענון
        ...
        <div className="container mt-5 d-flex justify-content-center">
            ...
            <div className="card" style={{ width: '400px', borderColor: '#007bf', borderWidth: '2px', borderStyle: 'solid' }}>{/*#ffa500*/}
                <div className="card-body">
                    <h5 className="card-title">עדכון משחק</h5>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        <input type={'number'} className="form-control" onBlur={(e) => setobj({ ...obj, quantityInStock: e.target.value })} placeholder={'amount'}></input>
                    </div>
